...
[***Readiness for Ecologically Beneficial Wildfire***]{.underline}

Many forests in the Western US are not ready for ecologically beneficial wildfire. A legacy of fire suppression and exclusion has caused abnormal fuel buildups, making fires more intense than local tree species can tolerate. This is particularly true in semi-arid forests adapted to frequent, low-to-moderate severity fires, while wetter forests adapted to infrequent, high-severity burning may be less affected. However, rising temperatures and increasingly variable precipitation will continue to shape wildfire readiness across the region.

I am leading a WFFRC-related effort to quantify and map the forested areas that are ready to burn in an ecologically beneficial way. Our definition of Readiness is: If an area were to burn, the fire is likely to burn consistent with the historical range of variability (i.e., the forest would likely return to its pre-fire state).

### Managing forest carbon in interior Alaska

I am a co-PI on a recently started a project funded by the [Joint Fire Science Program](https://www.firescience.gov/ords/prd/jf_jfsp/jf_jfsp/r/jfspublic/home) to assess the risk of forest carbon loss to fire in interior Alaska, predict forest recovery after fire for the next century, and project the impacts of potential management strategies. Our project, titled *Informing effective strategies for managing carbon stores with increasing fire in boreal forests of interior Alaska* will co-produce potential management scenarios to maximize forest carbon storage by communicating with natural resource managers and stakeholders.

## Postdoctoral Research

### **Forest carbon storage in the Western United States: distribution, drivers, and trends**

My Postdoctoral Research was funded by the Environmental Defense Fund, focusing on analyzing the distribution, trends, and drivers of forest carbon in the Western US ([Hall et al. 2024 Earth's Future](https://agupubs.onlinelibrary.wiley.com/doi/full/10.1029/2023EF004399)). My collaborators and I used USDA Forest Inventory and Analysis (FIA) survey data (2005-2019) compare carbon between 19 forested ecoregions. Using GIS and statistical analysis, we analyzed patterns in the spatial distribution of forest carbon and identified social and biophysical carbon drivers, including tree harvest, fire occurrence and severity, insect and disease presence, topography, and climate indices. We evaluated driver importance as well as driver relationships with carbon using machine learning models and a model interpretation technique rooted in game theory. Finally, we assessed ecoregion-level recent carbon trends using linear models.
...
Finally, we tested whether forest cover and estimates of forest damage explain changes to Puerto Rican streamflow regimes after Hurricane María ([Hall et al. 2024 Hydrological Processes](https://onlinelibrary.wiley.com/doi/full/10.1002/hyp.15249)). Using statistical models, we found that nearly all watersheds experienced higher post-storm streamflow. Forest damage increased streamflow after the storm, and forests, however damaged, increase resistance to storm impacts on streamflow. On average, major changes to streamflow regimes lasted months, but residual changes remained for over a year. Our results demonstrate how interactions between forest damage and cover influence streamflow regimes and increase understanding of forest damage effects on watershed function.
